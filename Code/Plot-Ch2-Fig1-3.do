...
line gdp_pc year, ///
	...
	ylabel(, format(%7.0fc)) xlabel(1950(10)2010 2016) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig02003.eps", replace as(eps)	
graph export "./Drafts/chi-vollrath-fig02003.png", replace as(png) width($width)
