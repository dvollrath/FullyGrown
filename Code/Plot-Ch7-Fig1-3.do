...
line share_VA year if code=="C" /// manufacturing
	...
	xlabel(1970(5)2015) ylabel(0(.05).25, format(%9.2f)) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig07001.eps", replace as(eps)			
graph export "./Drafts/chi-vollrath-fig07001.png", replace as(png) width($width)
...
line VA_QI_index year if code=="C" /// manufacturing
	...
	xlabel(1970(5)2015) ylabel(100(100)1000, format(%9.0f)) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig07002.eps", replace as(eps)			
graph export "./Drafts/chi-vollrath-fig07002.png", replace as(png) width($width)	
...
line VA_P_index year if code=="C" /// manufacturing
	...
	legend(label(1 "Manufacturing") label(2 "Health and social") label(3 "Prof. services") label(4 "Info. and comm.")) ///
	xtitle("Year") ytitle("Price (1970=100)") ///
	xlabel(1970(5)2015) ylabel(100(100)1100, format(%9.0f)) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig07003.eps", replace as(eps)			
graph export "./Drafts/chi-vollrath-fig07003.png", replace as(png) width($width)
