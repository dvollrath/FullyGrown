...
twoway bar movers year ///
	|| scatter move_rate year, connect(line) yaxis(2) ///
	xtitle("Year") ytitle("Percentage of people who moved", axis(2)) ytitle("Number of movers (millions)") ///
	xlabel(1950(10)2010 2016) ylabel(0(5)20, axis(2))
graph export "./Drafts/chi-vollrath-fig13001.png", replace as(png) width(1500)
