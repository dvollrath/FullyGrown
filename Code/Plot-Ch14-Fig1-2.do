...
scatter rgsppw2016 alec_rank, ///
	...
	msymbol(none) mlabel(state) mlabposition(0) xlabel(1 10(10) 50) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig14001.eps", replace as(eps)			
graph export "./Drafts/chi-vollrath-fig14001.png", replace as(png) width($width)
...
scatter growth alec_rank, ///
	...
	msymbol(none) mlabel(state) mlabposition(0) xlabel(1 10(10) 50) ylabel(-4(1)3, format(%9.1f)) scheme(vollrath)
graph export "./Drafts/chi-vollrath-fig14002.eps", replace as(eps)				
graph export "./Drafts/chi-vollrath-fig14002.png", replace as(png) width($width)
